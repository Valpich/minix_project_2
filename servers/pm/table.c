...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 33 = access	*/
	do_get,		/* 34 = getgroups */
	do_topic_lookup,	/* 35 = do_topic_lookup	*/
	no_sys,		/* 36 = sync	*/
	do_kill,	/* 37 = kill	*/
	no_sys,		/* 38 = rename	*/
	no_sys,		/* 39 = mkdir	*/
	...
	no_sys,		/* 42 = pipe	*/
	do_times,	/* 43 = times	*/
	do_topic_create,	/* 44 = do_topic_create	*/
	no_sys,	/* 45 = no_sys	*/
	do_set,		/* 46 = setgid	*/
	do_get,		/* 47 = getgid	*/
	no_sys,		/* 48 = (signal)*/
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_topic_publisher,	/* 56 = do_topic_publisher	*/
	no_sys,	/* 57 = no_sys	*/
	do_topic_subscriber,		/* 58 = do_topic_subscriber	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	do_set,		/* 62 = setsid	*/
	...
	do_topic_publish,		/* 69 = do_topic_publish */
	do_retrieve,		/* 70 = do_retrieve	*/
	...
	do_print_publishers,		/* 79 = do_print_publishers */
	no_sys,		/* 80 = (getdents) */
	no_sys, 	/* 81 = unused */
	no_sys, 	/* 82 = (fstatfs) */
	no_sys, 	/* 83 = unused */
	...
	do_print_subscribers,		/* 103 = do_print_subscribers */
	do_getprocnr,	/* 104 = getprocnr */
	do_topic_delete,		/* 105 = do_topic_delete */
